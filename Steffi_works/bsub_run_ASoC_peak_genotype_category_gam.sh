...
#BSUB -R "span[hosts=1]"
#BSUB -q "large_mem"
#BSUB -J "run_ASoC_peak_genotype_category_gam"
#BSUB -o main_log/ASoC_peak_genotype_category_gam_%J.out
#BSUB -e main_log/ASoC_peak_genotype_category_gam_%J.err

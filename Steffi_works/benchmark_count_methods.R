...
tsv_list_4_match <-
  data.frame(
    ...
    stop("Not all sample IDs from TSV list are present in BAM counts. Check the sample_id extraction logic.")
    }
  ...
  merged_normalised_df[
    ...
    summary_message <-
      paste0(
        ...
        sum(merged_normalised_df$percRef > 0.5 & merged_normalised_df$adjPVal < 0.05),
        " of ",

...
[[ -f rs16966337_genotype_list.txt ]] &&
	rm rs16966337_genotype_npglut_list.txt
...
#	echo ${all_bams_to_merge[@]}
	...
	do
		...
		####
		printf "$(basename -- ${all_bams_to_merge[$k]})\t${cell_type_to_find}\t${time_stimulation[$i]}" >> rs16966337_genotype_npglut_list.txt
		### genotype at the site rs16966337 (chr16:9788096)
		samtools mpileup \
			-r "chr16:9788096-9788096" \
		       	${all_bams_to_merge[$k]} \
			>> rs16966337_genotype_npglut_list.txt

...
vcf_suffix="_05Sept23_use_WASP_genotyping.vcf"
...
temp_dir="/home/zhangs3/NVME/package_temp/GATK/group_63"
...
########## filter SNPs located in the hg38 blacklisted region #######
	...
	$gatk4 \
		...
		-R $ref_genome \
		-V $temp_dir/raw_variants.vcf \
		--mask $ref_path/hg38_blacklisted_regions.bed \
		--mask-name "blacklisted_regions" \

...
# Siwei 04 Jan 2023
# Barcode-wise dedup with WASP only, no calibration
...
DATA_DIR="/home/zhangs3/NVME/package_temp/WASP_temp_hg38_0hr_1"

OUTPUT_FINAL="known_genotypes_bwa_by_barcode_hg38_WASP_deduped_only_BAMs"
...
#		$samtools index $WASP_run_dir/${eachfile/%.bam/.sim_pe_reads.merged.sorted.bam}
		...
		parallel -a $input_barcode_file -j 16 \
...
#		       | grep -v -e 'XA:Z:' -e 'SA:Z:' \
	...
	################### Re-add readgroup     
        ...
        $samtools addreplacerg \
                ...
                | $samtools sort \
                -l 9 -m 10G -@ 16 \
                -o $OUTPUT_FINAL/$final_output_file_name_prefix'_bwa_barcode_known_genotypes_WASP_deduped_only.bam'

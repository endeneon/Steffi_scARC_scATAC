...
interval_file="/home/zhangs3/NVME/scARC_Duan_024_raw_fastq/GRCh38_output/Jubao_SNP_lookup_list.bed"
...
do
	...
	cp $temp_dir"/pre_output.vcf" $output_dir"/vcf_4_Jubao_geno_WASP_CD-"$each_indiv".vcf"
	##### cleanup
        rm -r $temp_dir

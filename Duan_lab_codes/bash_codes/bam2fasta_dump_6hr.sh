...
out_path="bam_dump_4_fasta_05Jul2022_hg38/hr_6"
temp_path="/home/zhangs3/NVME/package_temp/samtools_temp/hr_6"
...
readarray -t bam_input_list < all_groups/bam_list_6hr.list

# make the array of group names, need to have the same order
# as in the bam input list
group_name_prefix="/home/zhangs3/NVME/scARC_Duan_024_raw_fastq/GRCh38_output/txt_barcodes_for_ASoC/hr_6/"

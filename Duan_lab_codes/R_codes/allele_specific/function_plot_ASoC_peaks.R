...
plot_AsoC_peaks <- function(chr, start, end, gene_name = "",
  ...
  alTrack_Region <- AlignmentsTrack(paste("rs2027349_het_05Mar2019/", cell_type_to_plot, "_het_rs2027349.bam",
                                       collapse = "", sep = ""),
  ...
  alTrack_A <- AlignmentsTrack(paste("rs2027349_het_05Mar2019/SNP_split_output/", cell_type_to_plot, "_het_rs2027349.ref.A.bam",
                                          collapse = "", sep = ""),
                                    isPaired = T, coverageOnly = T,
                                    chromosome = as.character(unique(seqnames(cell_type))),
                                    genome = "hg38", type = "coverage",
  ...
  alTrack_G <- AlignmentsTrack(paste("rs2027349_het_05Mar2019/SNP_split_output/", cell_type_to_plot, "_het_rs2027349.alt.G.bam",
                                    collapse = "", sep = ""),
                              isPaired = T, coverageOnly = T,
                              chromosome = as.character(unique(seqnames(cell_type))),
                              genome = "hg38", type = "coverage",
  ...
  plotTracks(list(iTrack, gTrack, OvlTrack, snpTrack, grTrack),
             sizes = c(1,1,8,1,1),

...
plot_VPS45_isogenic <- function(chr, start, end, gene_name = "VPS45",
                                       mcols = 100, strand = "+",
  ...
  AA_track_region <- AlignmentsTrack("VPS45_isogenic/AA_2_merged_sorted.bam",
                                       ...
                                       transformation=function(x) {x * 0.9761727},
                                       ylim = c(0, ylimit),
                                       cex.axis = 1,
                                       col.title="black",
                                       col.axis="black",
                                       ...
                                       fontsize = 10,
                                       show.title = FALSE)
  GG_track_region <- AlignmentsTrack("VPS45_isogenic/GG_2_merged_sorted.bam",
                                     isPaired = T, coverageOnly = T,
                                     chromosome = as.character(unique(seqnames(cell_type))),
                                     genome = "hg38", type = "coverage",
                                     background.title = "black",
                                     fill.coverage = "blue",
                                     col.coverage = "blue",
                                     transformation=function(x) {x * 1.02755},
                                     ylim = c(0, ylimit),
                                     cex.axis = 1,
                                     col.title="black",
                                     col.axis="black",
                                     ...
                                     fontsize = 10,
                                     show.title = FALSE)
  AG_track_region <- AlignmentsTrack("VPS45_isogenic/Het_2_merged_sorted.bam",
                                     isPaired = T, coverageOnly = T,
                                     chromosome = as.character(unique(seqnames(cell_type))),
                                     genome = "hg38", type = "coverage",
                                     ...
                                     fill.coverage = "cyan",
                                     col.coverage = "cyan",
                                     transformation=function(x) {x * 0.996277},
                                     ylim = c(0, ylimit),
                                     cex.axis = 1,
                                     col.title="black",
                                     col.axis="black",
                                     ...
                                     fontsize = 10,
                                     show.title = FALSE)
  Het_AG_track_region <- AlignmentsTrack("VPS45_isogenic/Het_2_merged_sorted.bam",
                                     isPaired = T, coverageOnly = T,
                                     chromosome = as.character(unique(seqnames(cell_type))),
                                     genome = "hg38", type = "coverage",
                                     background.title = "black",
                                     ...
                                     fontsize = 10,
                                     show.title = FALSE)
  Het_A_track_region <- AlignmentsTrack("VPS45_isogenic/Het_2.ref.A.bam",
                                         isPaired = T, coverageOnly = T,
                                         chromosome = as.character(unique(seqnames(cell_type))),
                                         genome = "hg38", type = "coverage",
                                         ...
                                         fontsize = 10,
                                         show.title = FALSE)
  Het_G_track_region <- AlignmentsTrack("VPS45_isogenic/Het_2.alt.G.bam",
                                         isPaired = T, coverageOnly = T,
                                         chromosome = as.character(unique(seqnames(cell_type))),
                                         genome = "hg38", type = "coverage",
                                         background.title = "black",

...
plot_VPS45_6_lines_q20_45M <- function(chr, start, end, gene_name = "VPS45",
  ...
  AA_1_track_region <- AlignmentsTrack("VPS45_isogenic/Q20/AA-A11_S1_new_WASPed.q20.bam",
                                     ...
                                     transformation=function(x) {x * 0.9698},
                                     ylim = c(0, ylimit),
                                     cex.axis = 1,
                                     col.title="black",
                                     col.axis="black",
                                     ...
                                     fontsize = 10,
                                     show.title = FALSE)
  AA_2_track_region <- AlignmentsTrack("VPS45_isogenic/Q20/AA-H12_S2_new_WASPed.q20.bam",
                                       isPaired = T, coverageOnly = T,
                                       chromosome = as.character(unique(seqnames(cell_type))),
                                       genome = "hg38", type = "coverage",
                                       background.title = "transparent",
                                       fill.coverage = "orangered",
                                       col.coverage = "orangered",
                                       transformation=function(x) {x * 0.9231},
                                       ylim = c(0, ylimit),
                                       cex.axis = 1,
                                       col.title="black",
                                       col.axis="black",
                                       ...
                                       fontsize = 10,
                                       show.title = FALSE)
  GG_1_track_region <- AlignmentsTrack("VPS45_isogenic/Q20/GG-B11_S6_new_WASPed.q20.bam",
                                     isPaired = T, coverageOnly = T,
                                     chromosome = as.character(unique(seqnames(cell_type))),
                                     genome = "hg38", type = "coverage",
                                     background.title = "transparent",
                                     fill.coverage = "blue",
                                     col.coverage = "blue",
                                     transformation=function(x) {x * 1.0718},
                                     ylim = c(0, ylimit),
                                     cex.axis = 1,
                                     col.title="black",
                                     col.axis="black",
                                     ...
                                     fontsize = 10,
                                     show.title = FALSE)
  GG_2_track_region <- AlignmentsTrack("VPS45_isogenic/Q20/GG-G7_S7_new_WASPed.q20.bam",
                                       isPaired = T, coverageOnly = T,
                                       chromosome = as.character(unique(seqnames(cell_type))),
                                       genome = "hg38", type = "coverage",
                                       background.title = "transparent",
                                       fill.coverage = "blue",
                                       col.coverage = "blue",
                                       transformation=function(x) {x * 0.8932},
                                       ylim = c(0, ylimit),
                                       cex.axis = 1,
                                       col.title="black",
                                       col.axis="black",
                                       ...
                                       fontsize = 10,
                                       show.title = FALSE)
  AG_1_track_region <- AlignmentsTrack("VPS45_isogenic/Q20/CD11-1_S4_new_WASPed.q20.bam",
                                     isPaired = T, coverageOnly = T,
                                     chromosome = as.character(unique(seqnames(cell_type))),
                                     genome = "hg38", type = "coverage",
                                     background.title = "transparent",
                                     ...
                                     transformation=function(x) {x * 1.0183},
                                     ylim = c(0, ylimit),
                                     cex.axis = 1,
                                     col.title="black",
                                     col.axis="black",
                                     ...
                                     fontsize = 10,
                                     show.title = FALSE)
  AG_2_track_region <- AlignmentsTrack("VPS45_isogenic/Q20/CD11-2_S5_new_WASPed.q20.bam",
                                       isPaired = T, coverageOnly = T,
                                       chromosome = as.character(unique(seqnames(cell_type))),
                                       genome = "hg38", type = "coverage",
                                       background.title = "transparent",
                                       fill.coverage = "forestgreen",
                                       col.coverage = "forestgreen",
                                       transformation=function(x) {x * 0.9886},
                                       ylim = c(0, ylimit),
                                       cex.axis = 1,
                                       col.title="black",
                                       col.axis="black",

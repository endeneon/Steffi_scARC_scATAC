...
df_raw <-
  read.vcfR(file = "../Hanwen_ATACseq_test/GA_R21/VCFs/NGN2/reordered_10x/output/NGN2_22Jun2023_trimmed_merged_SNP_VF.vcf",
            limit = 2e9,
            verbose = T)
...
save.image("NGN2_36_lines_21Jun2023.RData")
...
write.table(df_assembled,
            file = "NGN2_36_lines_all_SNPs_26Jun2023.txt",
            quote = F, sep = "\t",
...
write.table(df_assembled_FDR_005,
            file = "NGN2_36_lines_005_26Jun2023.txt",
            quote = F, sep = "\t",
            row.names = F, col.names = T)
...
write.table(df_avinput,
            file = "NGN2_36_lines_005_26Jun2023.avinput",
            quote = F, sep = "\t",
            row.names = F, col.names = T)
...
ggplot(df_assembled,
  ...
  ggtitle(paste("NGN2-Glut, DP >= 20, minAllele >= 2, 36 lines;\n",

...
write.table(df_assembled,
            file = "NGN2_36_lines_all_SNPs_18Aug2023.txt",
            quote = F, sep = "\t",
...
write.table(df_assembled_FDR_005,
            file = "NGN2_36_lines_005_18Aug2023.txt",
            quote = F, sep = "\t",
            row.names = F, col.names = T)
...
write.table(df_avinput,
            file = "NGN2_36_lines_005_18Aug2023.avinput",
            quote = F, sep = "\t",
            row.names = F, col.names = T)
...
ggplot(df_assembled,
  ...
  ggtitle(paste("NGN2-Glut, DP >= 25, minAllele >= 2, 36 lines;\n",
...
save.image("NGN2_36_lines_18Aug2023.RData")

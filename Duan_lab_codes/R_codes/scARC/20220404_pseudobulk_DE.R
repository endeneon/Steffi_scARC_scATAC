...
GABA_pseudobulk <- data.frame(filler, filler, filler, filler, filler, 
...
filler <- rep(0, length(genelist))
npglut_pseudobulk <- data.frame(filler, filler, filler, filler, filler, 
                                filler, filler, filler, filler, filler, 
                                filler, filler, filler, filler, filler,
                                row.names = genelist)
...
filler <- rep(0, length(genelist))
nmglut_pseudobulk <- data.frame(filler, filler, filler, filler, filler, 
                                filler, filler, filler, filler, filler, 
                                filler, filler, filler, filler, filler,
                                row.names = genelist)

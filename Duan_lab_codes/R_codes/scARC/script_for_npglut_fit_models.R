# Chuxuan 03/14/2022
# script passing npglut subobject to monocle fit_models()
...
obj <- subset(obj, broad.cell.type == "NEFM_pos_glut")
...
gene_fits <- fit_models(cds = cds,
                               ...
                               verbose = T)
# extract coeff table
npglut_fit_coefs <- coefficient_table(gene_fits)
save(npglut_fit_coefs, file = "npglut_fit_coefs_filtered.RData")

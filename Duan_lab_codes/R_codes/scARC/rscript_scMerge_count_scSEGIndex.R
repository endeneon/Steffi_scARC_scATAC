...
# })
exprs_mat <- 
  SummarizedExperiment::assay(sce_merged_4_cell_type,
                              'counts')
sce_merged_4_cells_scSEGIndex <- 
...
save(sce_merged_4_cells_scSEGIndex,
     file = "sce_merged_4_cells_scSEGIndex.RData",
     compression_level = 9)

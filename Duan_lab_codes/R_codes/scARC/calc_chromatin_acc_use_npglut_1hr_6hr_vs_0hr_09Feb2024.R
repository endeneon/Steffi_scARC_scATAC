...
save(GRanges_all_peaks,
     file = "Granges_all_peaks_non_overlapping_500bp_all_typextime.RData")
...
save(peaks_flanking_npglut_1hr_SNPs,
     file = "peaks_flanking_npglut_1hr_SNPs_500bp.RData")
...
save(peaks_flanking_npglut_6hr_SNPs,
     file = "peaks_flanking_npglut_6hr_SNPs_500bp.RData")

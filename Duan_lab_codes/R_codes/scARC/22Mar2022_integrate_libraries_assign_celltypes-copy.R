...
save("integrated", file = "demuxed_obj_removed_rat_gene_after_integration_nfeat_3000_updated.RData")
...
# assign cell types
new.cluster.ids <-
  c("NEFM_pos_glut", "NEFM_neg_glut", "GABA", "NEFM_pos_glut", "NEFM_neg_glut",
    "SST_pos_GABA", "GABA", "SEMA3E_pos_GABA", "GABA", "NEFM_neg_glut",
    "GABA", "unknown glut", "unknown", "unknown glut", "unknown",

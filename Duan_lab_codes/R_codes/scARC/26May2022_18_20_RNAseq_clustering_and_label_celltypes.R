...
# After integration of 18-line and 20-line data, perform downstream analyses
...
# load data 
load("./18line_20line_combined_after_integration_nfeat_5000.RData")
...
DimPlot(integrated,
  ...
  NoLegend() +
  ggtitle("clustering of 18-line and 20-line combined RNAseq data") +
...
# assign cell types
new.cluster.ids <-
  c("NEFM_pos_glut", "NEFM_neg_glut", "GABA", "GABA", "SST_pos_GABA",
    "SEMA3E_pos_GABA", "GABA", "GABA", "GABA", "unknown",
    "NEFM_neg_glut", "unknown", "NEFM_pos_glut", "unknown_VIM_pos", "NEFM_neg_glut",
    "NEFM_pos_glut")
...
save(integrated_labeled, file = "18line_20line_combined_labeled_nfeat5000_obj.RData")

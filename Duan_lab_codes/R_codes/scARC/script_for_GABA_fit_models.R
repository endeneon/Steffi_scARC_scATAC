...
# Chuxuan 03/14/2022
# script passing GABA subobject to monocle fit_models()
...
obj <- subset(obj, broad.cell.type == "GABA")
...
# extract coeff table
GABA_fit_coefs <- coefficient_table(gene_fits)
save(GABA_fit_coefs, file = "GABA_fit_coefs_filtered.RData")

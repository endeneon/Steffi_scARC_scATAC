...
# QC, normalize, and cluster 10x-aggr aggregated 029 ATACseq data 
...
load("./029_clean_multiomic_obj_mapped_to_RNA.RData")
# QC ####
...
types <- unique(multiomic_obj$RNA.cell.type)
...
save(multiomic_obj, file = "029_multiomic_obj_normalized_and_clustered_w_RNA_celltypes.RData")

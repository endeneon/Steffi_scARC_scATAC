...
# 5-line 18-line combined differential expression analysis using pseudobulk
...
# make df ####
load("./5line_18line_combined_labeled_nfeat5000_obj.RData")
...
GABA_pseudobulk <- data.frame(filler, filler, filler, filler, filler, filler, filler,
...
filler <- rep(0, length(genelist))
npglut_pseudobulk <- data.frame(filler, filler, filler, filler, filler, filler, filler,
                              filler, filler, filler, filler, filler, filler, filler,
                              filler, filler, filler, filler, filler, filler, filler,
                              row.names = genelist)
...
filler <- rep(0, length(genelist))
nmglut_pseudobulk <- data.frame(filler, filler, filler, filler, filler, filler, filler,
                              filler, filler, filler, filler, filler, filler, filler,
                              filler, filler, filler, filler, filler, filler, filler,
                              row.names = genelist)
...
for (p in types){
  for (m in times){
    filenames <- c(filenames, paste(p, m, "./pseudobulk_DE/DE_analysis_res_full_dataframe.csv", sep = "_"))
  }
}
filenames
...
for (i in 1:length(res_0v1_list)){
  ...
  filename <- paste0("./pseudobulk_DE/basemean_filtered_full_res/", types[i], 
                     "_1v0_full_DEG_list_after_basemean_filtering_only.csv")
  print(filename)
  write.table(res, file = filename, quote = F, sep = ",", col.names = T,
              row.names = F)
  filename <- paste0("./pseudobulk_DE/significant_res/", types[i], 

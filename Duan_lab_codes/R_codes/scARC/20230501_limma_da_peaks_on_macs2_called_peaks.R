...
# Differential accessibility with limma on 018-029 newly called peaks
#based on 08Aug2022_combat_limma_18line_da_peaks.R
...
load("../")
load("/nvmefs/scARC_Duan_018/018-029_combined_analysis/multiomic_obj_with_new_peaks_labeled.Rdata")

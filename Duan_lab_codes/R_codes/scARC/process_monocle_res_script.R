...
setwd("~/NVME/scARC_Duan_018/Duan_project_024_RNA/Analysis_v4_combine_5_18_20line/Monocle_DE")

# GABA ####
print("load GABA")
load("./GABA_fit_coefs.RData")
...
pdf("nmglut_6v0_volcano_plot.pdf")
p <- ggplot(data = terms_6hr,
            aes(x = estimate,
                y = neg_log_pval,
                color = significance,
...
pdf("nmglut_1v0_volcano_plot.pdf")
p <- ggplot(data = terms_1hr,
            aes(x = estimate,
                y = neg_log_pval,
                color = significance,
...
pdf("npglut_6v0_volcano_plot.pdf")
p <- ggplot(data = terms_6hr,
            aes(x = estimate,
                y = neg_log_pval,
                color = significance,
...
pdf("npglut_1v0_volcano_plot.pdf")
p <- ggplot(data = terms_1hr,
            aes(x = estimate,
                y = neg_log_pval,
                color = significance,

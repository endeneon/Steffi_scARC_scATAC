...
setwd("/nvmefs/scARC_Duan_018/R_scARC_Duan_018/Analysis_RNAseq_v5_monocle/18line_output/")

# GABA ####
print("load GABA")
load("/nvmefs/scARC_Duan_018/R_scARC_Duan_018/Analysis_RNAseq_v5_monocle/GABA_fit_coefs.RData")
...
# write.table(terms_1hr, file = paste0("GABA", "_1v0_all_DEGs.csv"), quote = F, 
#             sep = ",", col.names = T)

terms_6hr <- table %>% filter(term == "time.ident6hr") %>% 
  select(gene_short_name, term, p_value, q_value, estimate) %>% arrange(estimate)
# write.table(terms_6hr, file = paste0("GABA", "_6v0_all_DEGs.csv"), quote = F, 
#             sep = ",", col.names = T)
...
# nmglut ####
print("load nmglut")
load("/nvmefs/scARC_Duan_018/R_scARC_Duan_018/Analysis_RNAseq_v5_monocle/nmglut_fit_coefs.RData")
...
# npglut ####
print("load npglut")
load("/nvmefs/scARC_Duan_018/R_scARC_Duan_018/Analysis_RNAseq_v5_monocle/npglut_fit_coefs.RData")

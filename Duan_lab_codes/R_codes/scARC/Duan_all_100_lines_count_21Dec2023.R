...
df_vcf_list <-
  dir(path = "./merge_60_lines_024_025_029_25Sept2023/output",
      pattern = "*20Dec2023\\.vcf$",
      recursive = T)
df_vcf_list

sample_names <-
  str_split(string = df_vcf_list,
            pattern = "scARC_100_lines_merge_all_VQSR_",
            simplify = T)[, 2]
sample_names <-
  str_remove(string = sample_names,
             pattern = "_20Dec2023\\.vcf$")
...
save.image(file = "temp_run_100_lines_21Dec2023.RData")

# for (i in 8:length(df_vcf_list)) {
#   print(paste0("The current sample is ",
#                df_vcf_list[i]))
#   master_vcf_list[[i]] <-
#     func_calc_vcr(paste0("./merge_60_lines_024_025_029_25Sept2023/output/",
...
for (i in 1:length(df_vcf_list)) {
  ...
  results_from_depth_calc <-
    function_calc_depth(vcr_readin = paste0("./merge_60_lines_024_025_029_25Sept2023/output/",
                                            df_vcf_list[i]))
  line_to_write <-
  ...
  cat(line_to_write,
      file = "Duan_100_lines_depth_30_2_21Dec2023.txt",
      sep = "\t",
      fill = F,
      append = T)
}

save.image(file = "Sum_100_lines_21Dec2023.RData")
...
dir.create("results_100_lines_22Dec2023")
...
for (i in 1:length(master_vcf_list)) {
  ...
  write.table(df_2_writeout,
              file = paste0("results_100_lines_22Dec2023/",
                            names(master_vcf_list)[i],
                            "_SNP_2_30_full.tsv"),
              quote = F, sep = "\t",
              row.names = F, col.names = T)
...
master_vcf_list[["0hr_GABA"]][[1]][master_vcf_list[["0hr_GABA"]][[1]]$ID == "rs2027349", ]
master_vcf_list[["1hr_GABA"]][[1]][master_vcf_list[["1hr_GABA"]][[1]]$ID == "rs2027349", ]
master_vcf_list[["6hr_GABA"]][[1]][master_vcf_list[["6hr_GABA"]][[1]]$ID == "rs2027349", ]


master_vcf_list[["0hr_nmglut"]][[1]][master_vcf_list[["0hr_nmglut"]][[1]]$ID == "rs2027349", ]
master_vcf_list[["1hr_nmglut"]][[1]][master_vcf_list[["1hr_nmglut"]][[1]]$ID == "rs2027349", ]
master_vcf_list[["6hr_nmglut"]][[1]][master_vcf_list[["6hr_nmglut"]][[1]]$ID == "rs2027349", ]

master_vcf_list[["0hr_npglut"]][[1]][master_vcf_list[["0hr_npglut"]][[1]]$ID == "rs2027349", ]
master_vcf_list[["1hr_npglut"]][[1]][master_vcf_list[["1hr_npglut"]][[1]]$ID == "rs2027349", ]
master_vcf_list[["6hr_npglut"]][[1]][master_vcf_list[["6hr_npglut"]][[1]]$ID == "rs2027349", ]

...
ggplot(df_2_plot,
  ...
  scale_x_continuous(name = "Accessibility in 1 hr npglut (log2 ATAC-seq peak RPKM)",
                     expand = c(0, 0),
                     breaks = seq(0, 12, 2), 
                     limits = c(0, 12.5)) +
  scale_y_continuous(name = "Accessibility in 0 hr npglut (log2 ATAC-seq peak RPKM)",
                     expand = c(0, 0),
                     breaks = seq(0, 12, 2), 
                     limits = c(0, 12.5)) +

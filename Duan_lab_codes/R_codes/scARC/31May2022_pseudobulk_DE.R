...
# make df ####
load("./18line_20line_combined_labeled_nfeat5000_obj.RData")
...
coldata_npglut <- data.frame(condition = str_extract(string = colnames(npglut_pseudobulk),
                             ...
                             type = str_extract(string = colnames(npglut_pseudobulk),
                                                pattern = "^[0-9]+-"))
rownames(coldata_npglut) <- colnames(npglut_pseudobulkhttps://www.nature.com/articles/s41586-021-03955-9?WT.ec_id=NATURE-20211007&utm_source=nature_etoc&utm_medium=email&utm_campaign=20211007&sap-outbound-id=489768122AEDF3E192E20ACB25F089FC8002FF18)
...
pathlist <- list.files("./pseudobulk_DEresults/basemean_filtered_full_res/", full.names = T,
                       pattern = "1v0|6v0")
pathlist

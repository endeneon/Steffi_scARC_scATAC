# Chuxuan Li 02/02/2022
# Using the cell types identified in 24Jan2022_20line_RNAseq_analysis, make
#pseudobulk samples from each libraries and do differential expression analysis
...
# make df ####
load("/nvmefs/scARC_Duan_018/R_scARC_Duan_018/Analysis_RNAseq_v3_normalize_by_6libs_integrate_by_Seurat/rpca_integrated_labeled_obj.RData")

line_time <- unique(RNAseq_integrated_labeled$lib.ident)

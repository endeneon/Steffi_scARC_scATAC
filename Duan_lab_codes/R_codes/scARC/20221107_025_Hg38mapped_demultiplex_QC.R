...
load("/nvmefs/scARC_Duan_018/Duan_project_025_RNA/Analysis_part1_hybrid_genome/removed_rat_list_025_mapped_to_hybrid.RData")
...
setwd("/nvmefs/scARC_Duan_025_GRCh38/barcodes_demuxed_by_library")
...
VlnPlot(rough_merged, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), 
        ncol = 3)
sum(rough_merged$percent.mt > 15) #700
sum(rough_merged$nFeature_RNA > 7500) #912
sum(rough_merged$nCount_RNA > 40000) #593
sum(rough_merged$nFeature_RNA < 300) #49
sum(rough_merged$nCount_RNA < 500) #134

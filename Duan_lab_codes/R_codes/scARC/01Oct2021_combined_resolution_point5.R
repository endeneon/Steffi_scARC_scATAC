# Chuxuan Li 10/1/2021
# Analyze combined_gex, change resolution to 0.5 
# init
library(Seurat)
library(sctransform)
library(glmGamPoi)
...
combined_gex <- readRDS("~/NVME/scARC_Duan_018/R_scARC_Duan_018/DESeq2/combined_g2_g8_USE_THIS.rds")

seurat_obj <- FindClusters(combined_gex,
                           verbose = T, 
                           resolution = 0.5,
                           random.seed = 42)

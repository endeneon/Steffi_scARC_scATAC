...
# Chuxuan 03/14/2022
# script passing nmglut subobject to monocle fit_models()
...
obj <- subset(obj, broad.cell.type == "NEFM_neg_glut")
...
# extract coeff table
nmglut_fit_coefs <- coefficient_table(gene_fits)
save(nmglut_fit_coefs, file = "nmglut_fit_coefs_filtered.RData")

...
# Normalize -> integrate -> cluster -> label 025 17 and 46 data
...
load("./GRCh38_mapped_after_QC_list_17_46.RData")
...
integrated <- IntegrateData(anchorset = anchors,
                            verbose = T)
save(transformed_lst, file = "transformed_and_prepared_for_integration_list_17_46.RData")
save(integrated, file = "integrated_obj_17_46.RData")
...
DimPlot(integrated, label = T, group.by = "seurat_clusters") +
  NoLegend() +
  ggtitle("Clustering 025 - lib 17 & 46 RNAseq data") +
...
save(integrated_labeled, file = "./Analysis_part2_GRCh38/integrated_labeled_17_46.RData")

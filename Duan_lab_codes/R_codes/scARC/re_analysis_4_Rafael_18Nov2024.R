...
# remove any legacy assays, de novo from RNA ####
integrated_labeled@assays$SCT <- NULL
integrated_labeled@assays$integrated <- NULL

integrated_labelled_filtered_raw_RNA_only <-
  integrated_labeled

saveRDS(integrated_labelled_filtered_raw_RNA_only,
        file = "integrated_labelled_filtered_raw_RNA_only_oc2_18Nov2024.RDs")
# rm(integrated_labeled)

integrated_labelled_filtered_raw_RNA_only <-
  readRDS("oc2_mm10_analysis/integrated_labelled_filtered_raw_RNA_only_oc2_18Nov2024.RDs")
...
# unique(Harmony_neurons_only$)

integrated_rabbit_w_conditions <-
  readRDS("oc2_mm10_analysis/integrated_rabbit_w_conditions.RDs")
DefaultAssay(integrated_rabbit_w_conditions) <-
  "integrated"
DimPlot(integrated_rabbit_w_conditions)
Idents(integrated_rabbit_w_conditions)
unique(integrated_rabbit_w_conditions$orig.ident)

head(rownames(integrated_rabbit_w_conditions))

FeaturePlot(integrated_rabbit_w_conditions,
            features = "ENSOCUG00000016389")
FeaturePlot(integrated_rabbit_w_conditions,
            features = "ENSOCUG00000012644")
ENSOCUG00000012644
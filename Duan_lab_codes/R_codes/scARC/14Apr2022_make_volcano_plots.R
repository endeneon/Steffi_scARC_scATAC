...
# Use 5 and 18 line combined pseudobulk DEG lists to plot volcano plots
...
namelist
setwd("/nvmefs/scARC_Duan_018/Duan_project_024_RNA/Analysis_v2_combine_5line_18line/pseudobulk_DE/volcano_plots")
